...
// ============================================================================
// Renderizamos UNA sola variante según viewport (matchMedia) para que el
// árbol DOM no contenga las dos. Antes había clases responsive `lg:hidden`
// y `hidden lg:flex` que dejaban ambas copias en el DOM, duplicando inputs
// y rompiendo lectores de pantalla y automatización.
// ============================================================================
...
const widthMap = { sm: 'max-w-[420px]', md: 'max-w-[500px]', lg: 'max-w-[620px]' };
...
export default function Modal({
  ...
  return createPortal(
    isDesktop
      ? (
        <div role="dialog" aria-modal="true" aria-label={title} className="fixed inset-0 z-50 flex items-start justify-end">
          <div

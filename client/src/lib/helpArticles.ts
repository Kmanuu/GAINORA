...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    id:            'primeros-pasos',
    category:      'empezar',
    title:         'Primeros 10 minutos en HorasPRO',
    summary:       'Lo mínimo que necesitas hacer para que el dashboard te diga la verdad.',
    relatedRoutes: ['/dashboard'],
    readingTime:   '3 min',
    blocks: [
      { type: 'p', content: 'HorasPRO solo es útil si los datos son reales. Y los datos reales necesitan que tú los metas. La buena noticia: solo tienes que hacerlo una vez para los costes fijos, y unos pocos minutos al día para las horas.' },
      { type: 'h3', content: 'Paso 1 — Mete tus costes fijos' },
      { type: 'p', content: 'Son los gastos que pagas independientemente de si trabajas o no: alquiler, software, gestoría, internet, móvil, seguros... Sin esto, HorasPRO no puede calcular tu coste por hora real.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', content: 'El "coste por hora real" se calcula así: HorasPRO suma todos tus costes fijos del mes y los divide entre las horas que tú declaras que puedes trabajar. Eso da el coste de cada hora antes de ganar nada.' },
  ...
  },
  {
    ...
    readingTime:   '3 min',
    blocks: [
      { type: 'p', content: 'Cuando calculas si un proyecto es rentable, hay que decidir cómo "repartir" tus costes fijos (alquiler, software, gestoría) entre los distintos proyectos. HorasPRO te deja elegir entre dos formas.' },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    readingTime:   '3 min',
    blocks: [
      { type: 'p', content: 'En HorasPRO, "cobro" es cada cantidad que un cliente te tiene que pagar. Puede ser un proyecto cerrado, una mensualidad de suscripción o una bolsa de horas.' },
      { type: 'h3', content: 'De dónde salen los cobros' },
      { type: 'list', content: [
        'Si tienes una suscripción mensual: HorasPRO genera el cobro automáticamente cada mes (cron diario a las 03:00).',
      ...
      { type: 'p', content: 'Pulsa "Cobrar" en cualquier cobro. Indica cuánto te ha pagado, cuándo, por qué método (transferencia, tarjeta, efectivo) y opcionalmente la referencia bancaria. HorasPRO recalcula automáticamente lo que queda pendiente.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'list', content: [
        'Número correlativo único (sin saltos) dentro de una serie. HorasPRO los genera atómicamente para que dos facturas no compartan número.',
      ...
      { type: 'p', content: 'En HorasPRO empiezas con una sola serie ("A" — General). Si necesitas separar tipos de facturas (rectificativas, simplificadas, distinta actividad) puedes crear más series desde Ajustes → Facturación.' },
      { type: 'h3', content: 'Anular una factura: usar rectificativa, no borrar' },
      { type: 'warn', content: 'Una factura emitida NO se puede borrar legalmente. Si te equivocaste, debes emitir una factura RECTIFICATIVA con importes negativos que cancele la original. HorasPRO lo hace por ti con el botón "Anular": marca la original como anulada y emite la rectificativa automáticamente.' },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'warn', content: 'HorasPRO te da los NÚMEROS pero NO presenta la declaración a la AEAT. Esa parte se hace en la web de Hacienda o se pasa a un gestor. El objetivo de la app es que tengas los datos correctos en la mano sin escarbar en Excel.' },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'p', content: 'Cada noche a las 03:00 (hora Madrid), HorasPRO revisa todas las suscripciones activas y genera los cobros pendientes. Si activaste una suscripción hace 3 meses y nunca la abriste, al volver verás los 3 cobros generados, sin perder ninguno.' },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'p', content: 'Pulsa "Iniciar timer" cuando empieces a trabajar en un proyecto. HorasPRO empieza a contar segundos. Cuando termines, pulsa "Parar y guardar". El timer se mantiene aunque cierres el navegador (se guarda en local).' },

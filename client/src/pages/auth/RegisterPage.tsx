...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F5F5F7] px-4 py-12">
        ...
        >
          <div className="px-8 pt-8 pb-8">
            ...
            <div className="flex flex-col items-center mb-7">
              ...
              <h1 className="text-[22px] font-semibold text-[#1D1D1F]">Crear cuenta</h1>
              <p className="text-[14px] text-[#6E6E73] mt-1">Configura tu empresa en HorasPRO</p>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-3">
              ...
              {apiError && (
                ...
                >
                  ...
                  <p className="text-[13px] text-[#D93025]">{apiError}</p>
                </div>
              )}
      ...
      <p className="mt-8 text-[12px] text-[#86868B]">HorasPRO © {new Date().getFullYear()}</p>
    </div>
  );
}
...
function SectionDivider({ label, icon: Icon }: { label: string; icon: React.ElementType }) {
  return (
    <div className="flex items-center gap-2 pb-1">
      <Icon className="w-3.5 h-3.5 text-[#86868B]" strokeWidth={1.8} />
